...
**https://github.com/buzzcauldron/dendro-shell**
...
```bash
# 1. Create an empty public repo: https://github.com/new → buzzcauldron/dendro-shell
...
cd dendro-shell
git checkout -B main
git remote set-url origin https://github.com/buzzcauldron/dendro-shell.git
...
```bash
git clone https://github.com/buzzcauldron/dendro-shell.git
cd dendro-shell
